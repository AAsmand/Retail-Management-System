...
namespace Project
{
    public partial class AddSellInvoice : Form
    {
        ...
        public SaleInvoiceBusiness sellInvoiceBusiness;
        public AddSellInvoice()
        {
            InitializeComponent();
            sellInvoiceBusiness = new SaleInvoiceBusiness();
        ...
        private void BuyInvoiceItemGridView_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
                ...
                e.RowIndex >= 0)
            {
                ...
                {
                    itemForm = new ChooseForm(new ItemUiView(SellInvoiceItemGridView.Rows[e.RowIndex].Cells["ItemId"].Value != DBNull.Value ? (int)SellInvoiceItemGridView.Rows[e.RowIndex].Cells["ItemId"].Value : 0));
                ...
                e.RowIndex >= 0)
            {
                if ((int)SellInvoiceItemGridView.Rows[e.RowIndex].Cells["HasTracingFactor"].Value != 0)
                {
                    ...
                    {
                        chooseStockItemForm = new ChooseForm(new StockItemUiView(SellInvoiceItemGridView.Rows[e.RowIndex].Cells["ItemId"].Value != DBNull.Value ? (int)SellInvoiceItemGridView.Rows[e.RowIndex].Cells["ItemId"].Value : 0, SellInvoiceItemGridView.Rows[e.RowIndex].Cells["StockRoomId"].Value != DBNull.Value ? (int)SellInvoiceItemGridView.Rows[e.RowIndex].Cells["StockRoomId"].Value : 0));
